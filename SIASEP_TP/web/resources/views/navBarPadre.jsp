    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-menu">
            <ul class="nav nav-pills">
                ...
                <li><a id="pill_prematricula_alumno" data-toggle="pill" href="#prematricula-alumno">
                        <i class="fa fa-book"></i><span>Pre-matricula 2019</span><span class="badge badge-pill badge-warning">Nuevo</span></a>
                </li>
                <li><a id="pill_inscribir_evento" data-toggle="pill" href="#inscribir-evento">
                        <i class="fa fa-book"></i><span>Inscribir evento escolar</span></a>
                </li>
                <li><a href="#">
