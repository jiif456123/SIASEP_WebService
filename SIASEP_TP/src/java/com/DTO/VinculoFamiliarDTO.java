...
public class VinculoFamiliarDTO {
    ...
    public boolean isFlg_copia_dni_apo() {
        return flg_copia_dni_apo;
    }

    public void setFlg_copia_dni_apo(boolean flg_copia_dni_apo) {
        this.flg_copia_dni_apo = flg_copia_dni_apo;
    }
    ...
    public Date getFec_inicio_vinculo() {
        return fec_inicio_vinculo;
    }

    public void setFec_inicio_vinculo(Date fec_inicio_vinculo) {
        this.fec_inicio_vinculo = fec_inicio_vinculo;
    }

    public Date getFec_fin_vinculo() {
        return fec_fin_vinculo;
    }

    public void setFec_fin_vinculo(Date fec_fin_vinculo) {
        this.fec_fin_vinculo = fec_fin_vinculo;
    }

    public String getEs_apoderado() {
        return es_apoderado;
    }

    public void setEs_apoderado(String es_apoderado) {
